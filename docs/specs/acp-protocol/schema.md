...
**Note:** The document appears to have been truncated. The content provided ends at the `SessionUpdate` definition and does not include the complete schema definitions that would follow in the original document.