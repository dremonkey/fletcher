 ...
 */
export declare function resolveSessionKey(participantCount: number, participantIdentity: string, roomName: string, speakerVerified: SpeakerVerification): SessionKey;
/**
 ...
 */
export declare function resolveSessionKeySimple(participantIdentity: string, ownerIdentity: string | undefined, roomName?: string, participantCount?: number): SessionKey;
