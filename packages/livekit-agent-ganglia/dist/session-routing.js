 ...
 */
export function resolveSessionKey(participantCount, participantIdentity, roomName, speakerVerified) {
 ...
 */
export function resolveSessionKeySimple(participantIdentity, ownerIdentity, roomName = '', participantCount = 1) {
    const verified = ownerIdentity && participantIdentity === ownerIdentity ? 'owner' : 'guest';
