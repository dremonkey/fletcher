...
- [~] 009: Bluetooth audio route recovery — `restartTrack()` swaps audio source without unpublishing; pending field test ([BUG-004](../docs/field-tests/20260301-buglog.md))
