...
- [ ] 097: Prompt Timed Out UX Bug ⚠️ — Client shows timeout error during long-running ACP tasks; need to distinguish between transport failure and long processing times ([BUG-050](../docs/field-tests/20260317-buglog.md))
- [ ] 098: Surface Tool Calls in Chat Mode ⚠️ — Relay/Client not surfacing tool status in text-mode; leads to "black hole" UX and timeouts; forward ACP tool/status events to mobile data channel ([BUG-051](../docs/field-tests/20260317-buglog.md))
