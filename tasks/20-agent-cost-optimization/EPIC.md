...
### 011: Hold Mode — Idle Detection & Release
Voice agent idle timer: after N seconds of silence, send `session_hold` event, disconnect. Client shows "on hold — tap to resume." Fresh agent dispatched on resume. Fixes BUG-027 (silent pipeline death).
